...
<head>
    ...
    <title>Newzealand Kitchen</title>
    ...
    <link rel="icon" type="image/png" sizes="192x192" href="assets/img/favicons/192 x 192.png">
    <link rel="icon" type="image/png" sizes="32x32" href="assets/img/favicons/32 x 32.png">
    <link rel="icon" type="image/png" sizes="96x96" href="assets/img/favicons/96 x 96.png">
    <link rel="icon" type="image/png" sizes="16x16" href="assets/img/favicons/16 x 16.png">
                ...
                <div class="col-lg-7">
                    <div class="product-thumb-area">
                        ...
                        <div class="product-big-img th-carousel" data-slide-show="1" data-md-slide-show="1" data-fade="true">
                            <div class="col-auto">
                                <div class="img"><img src="assets/img/menu/product_details_1_1.png" alt="Product Image"></div>
                            </div>
                            <div class="col-auto">
                                <div class="img"><img src="assets/img/menu/product_details_1_2.png" alt="Product Image"></div>
                            </div>
                            <div class="col-auto">
                                <div class="img"><img src="assets/img/menu/product_details_1_3.png" alt="Product Image"></div>
                            </div>
                            <div class="col-auto">
    ...
    <div class="th-menu-wrapper">
        <div class="th-menu-area text-center">
            ...
            <div class="mobile-logo">
                <a href="index.html"><img src="assets\img\New folder\logo.png" alt="Newzealand Kitchen"></a>
            </div>
            <div class="th-mobile-menu">
                <ul>
                    <li class="menu-item-has-children">
                        ...
                        <!-- <ul class="sub-menu">
                            ...
                            <li><a href="home-tea-coffee.html">Tea Coffee Home <span class="new-label">New</span></a></li>
                            <li><a href="home-restaurant-v2.html">Restaurant Home <span class="new-label">New</span></a></li>
                            <li><a href="home-fast-food-v2.html">Fast Food Home <span class="new-label">New</span></a></li>
                            <li><a href="home-pizza-burger.html">Pizza & Burger Light <span class="new-label">New</span></a></li>
                            <li><a href="home-pizza-burger-dark.html">Pizza & Burger Dark <span class="new-label">New</span></a></li>
                        </ul> -->
                    </li>
                    <li>
                ...
                <a  href="assets/menu/Newzealandkitchen.pdf" target="_blank" class="th-btn style7 rounded-2"style="margin : 20px 40px ;">Download Menu<i class="fa-solid fa-arrow-right ms-2" style="transform: rotate(90deg);"></i></a>
            </div>
        </div>
    </div><!--==============================
	Header Area
                ...
                <div class="row justify-content-center justify-content-lg-between align-items-center">
                    <div class="col-auto d-none d-lg-block">
                        <div class="header-links">
                            <ul>
                                <li><i class="far fa-envelope"></i><a href="mailto:admin@newzealandkitchen.in">admin@newzealandkitchen.in</a></li>
                                <li><i class="far fa-location-dot"></i>#50-54-15, TPT Colony,
                                                    Seethammadara, Visakhapatnam - 530 013</li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-auto">
                    ...
                    <div class="row align-items-center justify-content-between">
                        <div class="col-auto">
                            <div class="header-logo">
                                <a href="#">
                                    <img src="assets/img/new/logo.png" alt="Newzealand Kitchen">
                                </a>
                            </div>
                        </div>
                        <div class="col-auto">
                        ...
                        <div class="col-auto">
                            <div class="header-button">
                                ...
                                <a href="assets/menu/Newzealandkitchen.pdf" target="_blank" class="th-btn style7 rounded-2">Download Menu<i class="fa-solid fa-arrow-right ms-2" style="transform: rotate(90deg);"></i></a>
                                <button id="downloadButton" type="button" class="th-menu-toggle d-inline-block d-lg-none"><i class="far fa-bars"></i></button>
                            </div>
                        </div>
                    </div>
                </div>
